...
//		}
		...
		//wxUser = getWXUser();
		if (wxUser!=null&&!wxUser.isTeacher&&wxUser.currentStudent == null&&("testPC".equals(deviceFlag)||isMobile(userAgent))){ //本地调试手机版页面使用
	...
	public static SessionInfo getSessionInfo() {
		...
		if (Cache.get(userKey)!=null) {
			...
			log.debug("getSession > session为空");
		}
		return sessionInfo;
	}
